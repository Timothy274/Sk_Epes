...
class Tambah_Stok extends StatefulWidget {
  final List<DataBarang> data;
  Tambah_Stok({Key key, this.data}) : super(key: key);

  @override
  _Tambah_StokState createState() => _Tambah_StokState();
}

class _Tambah_StokState extends State<Tambah_Stok> {
